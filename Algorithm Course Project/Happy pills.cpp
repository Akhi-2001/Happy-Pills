...
int main()
{
    ...
    cout<<endl;
    Register newUser;
    cout <<"OUR topics bsed on anti depression \nPlease register";
    cout <<"\n Enter your username:";
...
int solve2()
{
    ...
    int n;
    cout<<"\t\t\t\t NOW FIND YOUR PROBLEM QUICK FIX\n";

    {
        cout<<"Press 1 check your type and cure.......\n";
        cin>>n;
        switch(n)
        {
case 1:

    cout<<"\t\t\t\tTHERE ARE 5 TYPES and THERE CURE OF DEPRESSION-------\n";
    ...
    cout << "\n*Meditation and relaxation can work like medicine in this case\n\*nHang on with your loved or closed ones\n\n*consult a good doctor to treat you\n\n" << endl;
            ...
            break;
        default:
            cout<<"WRONG TYPES, PLEASE PRESS 1..........\n";
        }
    }
